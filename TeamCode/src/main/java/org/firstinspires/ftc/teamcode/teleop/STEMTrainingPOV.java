...
@TeleOp(name="Stem Training POV", group="Competition")
//@Disabled
public class STEMTrainingPOV extends LinearOpMode {
    ...
    double modifier = 1, speedSwitchSlow = 0.25, speedSwitchFast = 1, speedSwitchPow = 1;
    ...
    private void adjustPowers() {
        pow0 = Range.clip(g1[1] + g1[2], -1, 1);
        pow1 = Range.clip(g1[1] - g1[2], -1, 1);
        pow2 = Range.clip(g1[1] - g1[2], -1, 1);
        pow3 = Range.clip(g1[1] + g1[2], -1, 1);
    }
